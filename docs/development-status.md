...
- Blocked: the final authenticated-browser check requires Nathan to enter his password manually; UFW inspection/change still requires Nathan
...
- Next recommended task: harden the production Next.js CSP with per-response nonces, then have Nathan perform the credentialed login/dashboard check without sharing his password
