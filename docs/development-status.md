...
- 2026-08-25: Implemented market-close actionable rollover. After the 4:00 p.m. ET close, missed entry plans and their pending controlled intents expire, reserved capital is released, and the Dividend Calendar advances to opportunities whose entry session remains tradable. Expired records remain in immutable audit history.
