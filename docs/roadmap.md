...
3. **Aegis Data** — provider abstraction, historical/realtime/fundamental/economic/news data, normalization, cache, and quality.
...
7. **Aegis Intelligence** — AI-assisted creation/critique/research/review/detection and Strategy Council. AI never bypasses RiskEngine.
...
12. **Aegis Evolution** — continuous research/refinement/allocation/regime selection, agent evaluation, new data/brokers/assets, and optional local inference.
