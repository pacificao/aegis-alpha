...
def send(kind,cfg,test,detail_override=None):
    ...
    content={'premarket':('Pre-market Decision Briefing','Decisions that matter before the market opens.','Review fresh, cited Aegis Intelligence artifacts, market regime, economic events, scenario evidence, and the operator decision queue. Portfolio allocations remain unavailable until verified Phase 9 synchronization; no signal is inferred.'),'postmarket':('Post-market Highlights','The important outcomes from today.','Review post-market intelligence, anomalies, scenario research, and risk-control changes. Verified portfolio gains and attribution remain unavailable until Phase 9 synchronization; no performance is fabricated.'),'alert':('Attention Required','Aegis operator-attention alert.','TEST ALERT: delivery and escalation formatting validation only. No production incident or user action is currently asserted.')}
