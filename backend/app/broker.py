...
class BrokerAdapter(ABC):
    ...
    @abstractmethod
    def read_account_snapshot(self,selected_account_ref:str)->dict:...
class RobinhoodBrokerAdapter(BrokerAdapter):
    ...
    def read_account_snapshot(self,selected_account_ref:str)->dict:return self.client.account_snapshot(selected_account_ref)
