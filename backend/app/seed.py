...
def seed_roadmap(db: Session) -> None:
    ...
    if dividend_farm is None:
        db.add(StrategyScenario(name="Dividend Farm", strategy_type="DIVIDEND_FARM", description="Research whether dividend capture plus capital recycling produces attractive risk-adjusted returns.", lifecycle="RESEARCH", parameters={"max_position_pct": 1.0, "max_allocation_pct": 100.0, "min_annual_yield_pct": 1.0, "max_annual_yield_pct": 12.0, "min_dividend_event_pct": 0.15, "event_yield_sensitivity_pct": [0.10, 0.15, 0.25], "payment_frequencies": ["MONTHLY", "QUARTERLY", "SEMIANNUAL", "ANNUAL"], "min_dividend_history_years": 5, "min_historical_events": 12, "max_median_recovery_days": 30, "max_p90_recovery_days": 90, "min_recovery_probability_pct": 80.0, "max_historical_drawdown_pct": 15.0, "max_holding_days": 90, "min_market_cap_millions": 1000, "min_average_daily_dollar_volume": 5000000, "max_sector_exposure_pct": 20.0, "earnings_exclusion_days": 5, "include_reits": False, "include_etfs": False, "include_special_dividends": False, "entry_days_before_ex_date": 1, "exit_method": "PURCHASE_PRICE", "profit_target_pct": 0.0, "reinvest_dividends": True}))
    templates=(
